...
<figure class="wp-block-image alignfull size-full"><img src="https://s.w.org/wp-content/themes/wporg-showcase-2022/images/showcase.svg?v=20221121" alt="<?php esc_attr_e( 'WordPress Showcase text', 'wporg' ); ?>"/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
