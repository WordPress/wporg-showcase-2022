...
<!-- wp:jetpack/contact-form {"subject":"A new showcase site suggested.","to":"showcase.shouldbeblockedbyfilter@wordpress.org","customThankyou":"redirect","customThankyouRedirect":"<?php echo esc_attr( home_url( '/submit-a-wordpress-site/thanks/' ) ); ?>","style":{"spacing":{"margin":{"top":"var:preset|spacing|20"}}}} -->
<div class="wp-block-jetpack-contact-form" style="margin-top:var(--wp--preset--spacing--20)">
	...
	<!-- wp:jetpack/field-textarea {"label":"Why should this site be considered for the WordPress Showcase? What makes it unique or interesting?","required":true,"requiredText":"(required)"} /-->

	<!-- wp:jetpack/field-checkbox {"label":"Check this box if you own the site and agree to be contacted by email."} /-->
