...
<figure class="wp-block-image alignfull size-full"><img src="https://s.w.org/wp-content/themes/wporg-showcase-2022/images/showcase.svg?v=20221121" alt=""/></figure>
<!-- /wp:image --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<h2 class="has-text-align-left is-style-serif has-white-color has-text-color has-extra-large-font-size"><?php esc_attr_e( 'Featuring:', 'wporg' ); ?></h2>
<!-- /wp:heading -->
